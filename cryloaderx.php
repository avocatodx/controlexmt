...
/*   __________________________________________________
    |              Sn!pEr Web Developer                |  
    |               Author: @avocatodx                 |
    |       GitHub: https://github.com/avocatodx       |
    |__________________________________________________|
*/
...
// $password = 'bb372a3af426d363643aeaa92520061c'; //Default Pass: AWM
$win = substr(PHP_OS, 0, 3) == 'WIN' ? true : false;
$msg = 'Sn!pEr (avocat0@yahoo.com)'; //Copyright Do not Remove
