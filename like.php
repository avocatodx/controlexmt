...
?>
  ...
  $bw="cant find wallet";
          ...
          ?>
          <input type="text" class="form-control" value="17PZ3wvzonHRHFb9cejpw4faotGsi44nyu" id="myInputs" readonly>
          
          <div>
          <h5  class="red"> 
          <b>NOTE: </b>After copying the wallet address above, head over to your bitcoin wallet and make a trasnfer of the said amont you wish to invest into the company's wallet address provided above; after which you come back to this page and fill the fields below which is the amont you trasnfered to the company's wallet and your transaction ID. 
          </br>
          </br>
          After this process your deposit will be kept pending until the company confirms your depost on it's wallet then your desposit can be approved. Thanks
          </br>
          </br>
             Any malicious act of not making any payment and adding any fake
             TXID your account will be temporarily blocked
          </h5>
          </div> 
        
       
<button onclick="myFunctions()" class="btn btn-info mt-3">Copy Bitcoin Address</button>
<script>
